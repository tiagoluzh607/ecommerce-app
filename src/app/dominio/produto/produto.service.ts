...
export class ProdutoService{
    ...
    produtos: Produto[] = [
        ...
        {imagem: 'https://drive.google.com/uc?id=1R9kLIoWqNzsWJtGIoasy9mdHWnu9tdyF', nome: 'Botas Espaciais', avaliacao: 4.6, descricao: 'Sua principal função é manter os pés do trabalhador protegidos de qualquer perigo externo, como objetos cortantes, pregos, chão escorregadio, objetos caindo, entre outros.', preco: 49.90},
        {imagem: 'https://drive.google.com/uc?id=1DiwMfwpkxSMfTeq0lgtBICwdShBgXp81', nome: 'Bandeira do Brasil', avaliacao: 3, descricao: 'Conjunto de mastro de alumínio com suporte para parede em alumínio, extremamente resistente ao tempo, com uma bandeira do Brasil dupla face 68x97cm.', preco: 380},
        ...
        {imagem: 'https://drive.google.com/uc?id=1LgTW5YiSGWq0J6G-PzJwkJgcrgNoDwN9', nome: 'Uva Passa', avaliacao: 2, descricao: 'Quais os benefícios da uva passa? Além de saborosa, a uva passa proporciona energia e tem alto teor de vitaminas e minerais. ...', preco: 17.03},
        ...
        {imagem: 'https://drive.google.com/uc?id=1dL_dqlGBL_jEFEeNs6I5VwdLgtkiEK1J', nome: 'Melancia', avaliacao: 3, descricao: 'A melancia é um alimento que ajuda a manter o corpo hidratado, pois é composta por cerca de 90% de água.', preco: 2.99},
        {imagem: 'https://drive.google.com/uc?id=1OjXIOexBltZ7iWQkA-m1WXNNnKF5ysAo', nome: 'Pera', avaliacao: 5, descricao: 'É uma fruta que fornece nutrientes importantes para a saúde como vitamina A, E, C, fibras, potássio, magnésio e cálcio.', preco: 5},
